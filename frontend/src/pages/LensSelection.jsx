...
const LensSelection = () => {
  ...
  className="cursor-pointer p-6 rounded-xl bg-[#111] hover:scale-105 transition"
>
  <div className="text-3xl mb-3">{lens.icon}</div>
  <h2 className="text-white text-lg font-semibold">{lens.title}</h2>
  <p className="text-gray-400 text-sm mt-2">{lens.description}</p>
</div>
          ))}
        </div>
      </div>
